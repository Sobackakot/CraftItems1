...
public class CraftController : MonoBehaviour
{
    ...
    {
        bool condition = ShowChallenge.InstanceChallenge.Index < 20;
        bool condition2 = ShowChallenge.InstanceChallenge.Index < 40;
        string [] selectedArray = condition ? resourcesItemName1 : (condition2 ? resourcesItemName2 : resourcesItemName3); 
